...
combo1['values'] = ("English_en", "Spanish_es", "Portuguese_pt", "Chinese_zh-tw", "German_de", "French_fr", "Romanian_ro", "Russian_ru", "Arabic_ar", "Hindi_hi", "Bengali_bn", "Indonesian_id", "Urdu_ur", "Japanese_ja", "Swahili_sw", "Marathi_mr", "Telugu_te","Punjabi_pa","Tamil_ta","Turkish_tr", "Korean_ko","Italian_it","Dutch_nl")
combo1.current(0)
